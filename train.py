...
def add_train_args(arg_parser):
    ...
    arg_parser.add_argument('--backbone', default='Deeplab101_CLASS_INW',
    ...
    arg_parser.add_argument('--continue_training', default=False,
    ...
    arg_parser.add_argument('--freeze_bn', default=False,
    ...
    arg_parser.add_argument('--multi', default=False,
